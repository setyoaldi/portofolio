...
const Skills = () => {
  return (
    <div
      name="skills"
      className="h-auto md:h-screen w-full bg-[#0a192f] text-gray-300"
    >
      <div className="max-w-[1000px] h-full flex flex-col mx-auto p-4">
        <div className="p-4">
          <h1 className="text-4xl font-bold border-b-4 rounded-sm border-blue-500 inline pt-3">
            Skills
          </h1>
        ...
        <div className="w-full grid grid-cols-2 md:grid-rows-2 md:grid-cols-4 p-4 mx-auto h-full place-items-center">
          <div className="w-[180px] h-[170px] rounded shadow-md shadow-[#040c16] p-2 m-3 hover:scale-105 duration-200 ease-in-out">
            <img
              className="rounded mx-auto w-[80%] h-[80%]"
              src={HTML}
              alt="HTML"
            />
          ...
          <div className="w-[180px] h-[170px] rounded shadow-md shadow-[#040c16] p-2 m-3 hover:scale-105 duration-200 ease-in-out">
            <img
              ...
              alt="HTML"
            />
            <p className="text-lg uppercase text-center my-2 font-bold">
              Javascript
            </p>
          </div>
