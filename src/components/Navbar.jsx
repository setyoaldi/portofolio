  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="block md:hidden z-10 hover:cursor-pointer"
        id="icons"
      >
      ...
      <div className="hidden lg:flex fixed flex-col top-[35%] left-0 text-white -z-10">
        <ul className="flex flex-col">
          <li className="bg-blue-500 p-3 w-[120px] flex flex-row justify-between items-center ml-[-75px] hover:ml-0 ease-in-out duration-300">
            <a
          ...
          <li className="bg-gray-800 p-3 w-[120px] flex flex-row justify-between items-center ml-[-75px] hover:ml-0 ease-in-out duration-300 hover:cursor-pointer">
            <a
          ...
          <li className="bg-[#00df9a] p-3 w-[120px] flex flex-row justify-between items-center ml-[-75px] hover:ml-0 ease-in-out duration-300">
            <a href="mailto:contact.achmadsetyoaldi@gmail.com" target="_blank">
              GMail
            </a>{" "}
            <HiOutlineMail size={20} />
          </li>

          <li className="bg-gray-500 p-3 w-[120px] flex flex-row justify-between items-center ml-[-75px] hover:ml-0 ease-in-out duration-300 cursor-pointer">
            <a
              href="https://drive.google.com/file/d/1_JoEuQ7at441SjFv8kWkVm2Buul0IDAk/view?usp=sharing"
              target="_blank"
            >
              Resume
            </a>{" "}
